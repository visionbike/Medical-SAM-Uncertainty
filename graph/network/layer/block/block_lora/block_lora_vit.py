...
from ...lora import LoRAMultiheadAttention1, LoRAMLP1
...
class ViTLoRABlock(nn.Module):
    """Transformer blocks with LoRA for ViT with support of window attention and residual propagation blocks"""
    ...
    def __init__(
        ...
        **kwargs
        ...
        if mid_dim is not None:
            ...
            lora_rank = 4
        self.attn = LoRAMultiheadAttention1(
            dim,
            num_heads=num_heads,
            qkv_bias=qkv_bias,
